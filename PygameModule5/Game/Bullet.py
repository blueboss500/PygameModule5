...
class Bullet(GameObject):
    ...
    def __init__(self, position, sprite, game):
        ...
        super(Bullet, self).__init__(position, GameConstants.BULLET_SIZE, sprite)
    ...
    def changeDirection(self, gameObject):
        ...
        #Determine new direction based on if collision was on Top, Bottom, Left, or Right
        #...Then update the position of the ball based on where it hit.
